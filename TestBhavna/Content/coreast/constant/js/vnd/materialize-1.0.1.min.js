...
window.cash = function () {
    ...
    function C(t) {
        return _(s.call(t).filter(function (t, e, i) {
            return i.indexOf(t) === e
        }))
    }
    Object.defineProperty(y, "constructor", {
        value: _
    }), _.parseHTML = f, _.noop = r, _.isFunction = l, _.isString = h, _.extend = y.extend = function (t) {
        t = t || {};
    ...
    y.extend({
        data: function (t, e) {
            if (h(t)) return void 0 === e ? x(this[0], t) : this.each(function (i) {
                return O(i, t, e)
            });
        ...
        removeData: function (t) {
            return this.each(function (e) {
                return n = t, void ((s = M(i = e)) ? delete s[n] : i.dataset ? delete i.dataset[n] : _(i).removeAttr("data-" + name));
                var i, n, s
            })
        }
    });
    ...
    y.extend({
        ...
        filter: function (t) {
            if (!t) return this;
            var e = l(t) ? t : w(t);
            return _(o.call(this, function (i) {
                return e(i, t)
            }))
        },
        first: function () {
    ...
    var S, I, A, R, H, P = (R = /(?:^\w|[A-Z]|\b\w)/g, H = /[\s-_]+/g, function (t) {
        return t.replace(R, function (t, e) {
            return t[0 === e ? "toLowerCase" : "toUpperCase"]()
        }).replace(H, "")
    }),
        W = (S = {}, I = document.createElement("div"), A = I.style, function (t) {
    ...
    function F(t, e, i) {
        var n, s = x(t, "_cashEvents"),
            o = s && s[e];
        o && (i ? (t.removeEventListener(e, i), 0 <= (n = o.indexOf(i)) && o.splice(n, 1)) : (k(o, function (i) {
    ...
    _.prefixedProp = W, _.camelCase = P, y.extend({
        css: function (t, e) {
            if (h(t)) return t = W(t), 1 < arguments.length ? this.each(function (i) {
                return i.style[t] = e
        ...
        y[e] = function () {
            ...
            return this[0]["offset" + t] + (e ? j(this, "margin" + ("Width" === t ? "Left" : "Top")) + j(this, "margin" + ("Width" === t ? "Right" : "Bottom")) : 0)
        }
    }), y.extend({
        off: function (t, e) {
        ...
        on: function (t, e, i, n) {
            ...
            return l(e) && (i = e, e = null), "ready" === t ? (m(i), this) : (e && (s = i, i = function (t) {
                ...
                }), o = t, a = l, (r = x(s = e, "_cashEvents") || O(s, "_cashEvents", {}))[o] = r[o] || [], r[o].push(a), s.addEventListener(o, a)
            }))
        },
        one: function (t, e, i) {
...
M.anime = function () {
    ...
    function n(e) {
        return T.arr(e) ? e : (T.str(e) && (e = t(e) || e), e instanceof NodeList || e instanceof HTMLCollection ? [].slice.call(e) : [e])
    }
    ...
    function u(t, e) {
        return T.dom(t) && s(L, e) ? "transform" : T.dom(t) && (t.getAttribute(e) || T.svg(t) && t[e]) ? "attribute" : T.dom(t) && "transform" !== e && d(t, e) ? "css" : null != t[e] ? "object" : void 0
    }
        ...
        switch (u(t, i)) {
            case "transform":
                return function (t, i) {
                    ...
                    for (var o = [], a = [], r = [], l = /(\w+)\((.+?)\)/g; o = l.exec(t);) a.push(o[1]), r.push(o[2]);
    ...
    function y(t) {
        return e(t = t ? i(T.arr(t) ? t.map(n) : n(t)) : [], function (t, e, i) {
            return i.indexOf(t) === e
        })
    }
    ...
    function k(t, e) {
        ...
        if (T.arr(t)) {
            var s = t.length;
            2 !== s || T.obj(t[0]) ? T.fnc(e.duration) || (i.duration = e.duration / s) : t = {
                value: t
            }
        }
        return n(t).map(function (t, i) {
            return i = i ? 0 : e.delay, t = T.obj(t) && !T.pth(t) ? t : {
                value: t
            }, T.und(t.delay) && (t.delay = i), t
        }).map(function (t) {
            return r(t, i)
        })
    }
    ...
    function b(t, e) {
        ...
        return t.tweens.map(function (n) {
            ...
            o = l(r) || l(a) || l(o);
            return n.from = _(a, o), n.to = _(r, o), n.start = i ? i.end : t.offset, n.end = n.start + n.delay + n.duration, n.easing = function (t) {
                return T.arr(t) ? $.apply(this, t) : B[t]
            }(n.easing), n.elasticity = (1e3 - Math.min(Math.max(n.elasticity, 1), 999)) / 1e3, n.isPath = T.pth(s), n.isColor = T.col(n.from.original), n.isColor && (n.round = 1), i = n
        })
    }
    ...
    function C(t) {
        var n, s, o, l, h = a(O, t),
            d = a(x, t),
            c = (s = t.targets, (o = y(s)).map(function (t, e) {
                return {
                    target: t,
                    id: e,
                    total: o.length
            ...
            p = [],
            v = r(h, d);
        for (n in t) v.hasOwnProperty(n) || "targets" === n || p.push({
            name: n,
            offset: v.offset,
            tweens: k(t[n], d)
        });
        return l = p, t = e(i(c.map(function (t) {
    ...
    function E(t) {
        ...
        function s(t) {
            for (var i = 0, n = {}, s = v.animations, o = s.length; i < o;) {
                ...
                for (var h = Math.min(Math.max(t - l.start - l.delay, 0), l.duration) / l.duration, u = isNaN(h) ? 1 : l.easing(h, l.elasticity), c = (h = l.to.strings, l.round), p = [], f = void 0, m = (f = l.to.numbers.length, 0); m < f; m++) {
                    var _ = void 0,
                        y = (_ = l.to.numbers[m], l.from.numbers[m]);
                    _ = l.isPath ? g(l.value, u * _) : y + u * (_ - y);
                    c && (l.isColor && 2 < m || (_ = Math.round(_ * c) / c)), p.push(_)
                }
                if (l = h.length)
                    for (f = h[0], u = 0; u < l; u++) c = h[u + 1], m = p[u], isNaN(m) || (f = c ? f + (m + c) : f + (m + " "));
                else f = p[0];
                D[a.type](r.target, a.property, f, n, r.id), a.currentValue = f, i++
            }
        ...
        function r(t) {
            ...
            if (v.children.length) {
                ...
                if (g >= v.currentTime)
                    ...
                    for (; y--;) _[y].seek(g)
            } (d <= g || !e) && (v.began || (v.began = !0, o("begin")), o("run")), r < g && g < e ? s(g) : (g <= r && 0 !== f && (s(0), m && a()), (e <= g && f !== e || !e) && (s(e), m || a())), o("update"), e <= t && (v.remaining ? (h = l, "alternate" === v.direction && (v.reversed = !v.reversed)) : (v.pause(), v.completed || (v.completed = !0, o("complete"), "Promise" in window && (c(), p = i()))), u = 0)
        }
        t = void 0 === t ? {} : t;
        var l, h, u = 0,
            c = null,
        ...
        return v.reset = function () {
            ...
            var t = S.indexOf(v); - 1 < t && S.splice(t, 1), v.paused = !0
        }, v.play = function () {
            v.paused && (v.paused = !1, h = 0, u = n(v.currentTime), S.push(v), I || A())
        }, v.reverse = function () {
    ...
    var M, O = {
        ...
        $ = function () {
            ...
            return function (e, i, n, s) {
                if (0 <= e && e <= 1 && 0 <= n && n <= 1) {
                    ...
                    if (e !== i || n !== s)
                        for (var a = 0; a < 11; ++a) o[a] = t(.1 * a, e, n);
                    return function (a) {
                        if (e === i && n === s) return a;
                        if (0 === a) return 0;
                        if (1 === a) return 1;
                        ...
                        if (.001 <= h) {
                            for (r = 0; r < 4 && 0 != (h = 3 * (1 - 3 * n + 3 * e) * l * l + 2 * (3 * n - 6 * e) * l + 3 * e); ++r) {
                                var d = t(l, e, n) - a;
                                l = l - d / h
                            }
                            a = l
                            ...
                            l = r, r = r + .1;
                            for (var u = 0; 0 < (h = t(d = l + (r - l) / 2, e, n) - a) ? r = d : l = d, 1e-7 < Math.abs(h) && ++u < 10;);
                            a = d
                        }
                        return t(a, i, s)
                    }
        ...
        B = function () {
            ...
            var e, i = "Quad Cubic Quart Quint Sine Expo Circ Back Elastic".split(" "),
                n = {
                    ...
                    InOut: [
                        ...
                        [.68, -.55, .265, 1.55],
                        function (e, i) {
                            return e < .5 ? t(2 * e, i) / 2 : 1 - t(-2 * e + 2, i) / 2
                        }
                    ]
                },
                s = {
            ...
            for (e in n) o.type = e, n[o.type].forEach(function (t) {
                return function (e, n) {
                    s["ease" + t.type + i[n]] = T.fnc(e) ? e : $.apply($jscomp$this, e)
                }
            }(o)), o = {
                type: o.type
            };
    ...
    return E.version = "2.2.0", E.speed = 1, E.running = S, E.remove = function (t) {
        t = y(t);
        for (var e = S.length; e--;)
            for (var i = S[e], n = i.animations, o = n.length; o--;) s(t, n[o].animatable.target) && (n.splice(o, 1), n.length || i.pause())
    }, E.getValue = c, E.path = function (e, i) {
    ...
    }, E.bezier = $, E.easings = B, E.timeline = function (t) {
        var e = E(t);
        return e.pause(), e.duration = 0, e.add = function (i) {
            return e.children.forEach(function (t) {
                ...
                var s = n.offset;
                n.autoplay = !1, n.direction = e.direction, n.offset = T.und(s) ? i : p(s, i), e.began = !0, e.completed = !0, e.seek(n.offset), (n = E(n)).began = !0, n.completed = !0, n.duration > i && (e.duration = n.duration), e.children.push(n)
        ...
        var i = {
            ...
            n = function (n) {
                function s(e, i) {
                    ...
                    (n.el.M_Collapsible = n).options = t.extend({}, s.defaults, i), n.$headers = n.$el.children("li").children(".collapsible-header"), n.$headers.attr("tabindex", 0), n._setupEventHandlers();
        ...
        var i = {
            ...
            n = function (n) {
                function s(e, i) {
                    _classCallCheck(this, s);
                    var n = _possibleConstructorReturn(this, (s.__proto__ || Object.getPrototypeOf(s)).call(this, s, e, i));
                    return (n.el.M_Modal = n).options = t.extend({}, s.defaults, i), n.isOpen = !1, n.id = n.$el.attr("id"), n._openingTrigger = void 0, n.$overlay = t('<div class="modal-overlay"></div>'), n.el.tabIndex = 0, n._nthModalOpened = 0, s._count++, n._setupEventHandlers(), n
                }
                return _inherits(s, Component), _createClass(s, [{
                    key: "destroy",
                    value: function () {
        ...
        var i = {
            ...
            n = function (n) {
                function s(e, i) {
                    _classCallCheck(this, s);
                    var n = _possibleConstructorReturn(this, (s.__proto__ || Object.getPrototypeOf(s)).call(this, s, e, i));
                    return (n.el.M_Materialbox = n).options = t.extend({}, s.defaults, i), n.overlayActive = !1, n.doneAnimating = !0, n.placeholder = t("<div></div>").addClass("material-placeholder"), n.originalWidth = 0, n.originalHeight = 0, n.originInlineStyles = n.$el.attr("style"), n.caption = n.el.getAttribute("data-caption") || "", n.$el.before(n.placeholder), n.placeholder.append(n.$el), n._setupEventHandlers(), n
                }
                return _inherits(s, Component), _createClass(s, [{
                    key: "destroy",
                    value: function () {
        ...
        var e = {
            ...
            i = function (i) {
                function n(e, i) {
                    ...
                    return (s.el.M_Parallax = s).options = t.extend({}, n.defaults, i), s._enabled = window.innerWidth > s.options.responsiveThreshold, s.$img = s.$el.find("img").first(), s.$img.each(function () {
        ...
        var i = {
            ...
            n = function (n) {
                function s(e, i) {
                    _classCallCheck(this, s);
                    var n = _possibleConstructorReturn(this, (s.__proto__ || Object.getPrototypeOf(s)).call(this, s, e, i));
                    return (n.el.M_Tabs = n).options = t.extend({}, s.defaults, i), n.$tabLinks = n.$el.children("li.tab").children("a"), n.index = 0, n._setupActiveTabLink(), n.options.swipeable ? n._setupSwipeableTabs() : n._setupNormalTabs(), n._setTabsAndTabWidth(), n._createIndicator(), n._setupEventHandlers(), n
                }
                return _inherits(s, Component), _createClass(s, [{
                    key: "destroy",
                    value: function () {
        ...
        var i = {
            ...
            n = function (n) {
                function s(e, i) {
                    _classCallCheck(this, s);
                    var n = _possibleConstructorReturn(this, (s.__proto__ || Object.getPrototypeOf(s)).call(this, s, e, i));
                    return (n.el.M_Tooltip = n).options = t.extend({}, s.defaults, i), n.isOpen = !1, n.isHovered = !1, n.isFocused = !1, n._appendTooltipEl(), n._setupEventHandlers(), n
                }
                return _inherits(s, Component), _createClass(s, [{
                    key: "destroy",
                    value: function () {
    ...
    function (t) {
        ...
        var s = {
            ...
            show: function (t, e) {
                ...
                var a, r, l, h, d, u, c, p = (u = {
                    top: 0,
                    left: 0
                }, r = (c = (a = i) && a.ownerDocument).documentElement, void 0 !== a.getBoundingClientRect && (u = a.getBoundingClientRect()), l = null !== (d = h = c) && d === d.window ? h : 9 === h.nodeType && h.defaultView, {
        ...
        e.displayEffect = function (e) {
            "duration" in (e = e || {}) && (s.duration = e.duration), s.wrapInput(i(".waves-effect")), "ontouchstart" in t && document.body.addEventListener("touchstart", a, !1), document.body.addEventListener("mousedown", a, !1)
        }, e.attach = function (e) {
        ...
        var i = {
            ...
            n = function () {
                function n(e) {
                    ...
                    (i.M_Toast = this).el = i, this.$el = t(i), this._animateIn(), this._setTimer()
                }
                return _createClass(n, [{
                    ...
                    value: function () {
                        ...
                        t.setAttribute("id", "toast-container"), t.addEventListener("touchstart", n._onDragStart, {
                            ...
                            passive: !0
                        }), document.body.appendChild(t), n._container = t
                    }
                }, {
                    ...
                    value: function (e) {
                        if (e.target && t(e.target).closest(".toast").length) {
                            ...
                            i.panning = !0, (n._draggedToast = i).el.classList.add("panning"), i.el.style.transition = "", i.startingXPos = n._xPos(e), i.time = Date.now(), i.xPos = n._xPos(e)
                        }
                    }
                }, {
                    key: "_onDragMove",
                    ...
                    value: function () {
                        if (n._draggedToast) {
                            ...
                            Math.abs(e) > i || 1 < t.velocityX ? (t.wasSwiped = !0, t.dismiss()) : (t.el.style.transition = "transform .2s, opacity .2s", t.el.style.transform = "", t.el.style.opacity = ""), n._draggedToast = null
                        }
                    }
                }, {
                    key: "_xPos",
        ...
        var i = {
            ...
            n = function (n) {
                function s(e, i) {
                    _classCallCheck(this, s);
                    var n = _possibleConstructorReturn(this, (s.__proto__ || Object.getPrototypeOf(s)).call(this, s, e, i));
                    return (n.el.M_Sidenav = n).id = n.$el.attr("id"), n.options = t.extend({}, s.defaults, i), n.isOpen = !1, n.isFixed = n.el.classList.contains("sidenav-fixed"), n.isDragged = !1, n.lastWindowWidth = window.innerWidth, n.lastWindowHeight = window.innerHeight, n._createOverlay(), n._createDragTarget(), n._setupEventHandlers(), n._setupClasses(), n._setupFixed(), s._sidenavs.push(n), n
                }
                return _inherits(s, Component), _createClass(s, [{
                    key: "destroy",
                    value: function () {
                    ...
                    key: "_setupEventHandlers",
                    value: function () {
                        0 === s._sidenavs.length && document.body.addEventListener("click", this._handleTriggerClick), this._handleDragTargetDragBound = this._handleDragTargetDrag.bind(this), this._handleDragTargetReleaseBound = this._handleDragTargetRelease.bind(this), this._handleCloseDragBound = this._handleCloseDrag.bind(this), this._handleCloseReleaseBound = this._handleCloseRelease.bind(this), this._handleCloseTriggerClickBound = this._handleCloseTriggerClick.bind(this), this.dragTarget.addEventListener("touchmove", this._handleDragTargetDragBound, {
                            passive: !0
                            ...
                            passive: !0
                        }), this.el.addEventListener("click", this._handleCloseTriggerClickBound), this.isFixed && (this._handleWindowResizeBound = this._handleWindowResize.bind(this), window.addEventListener("resize", this._handleWindowResizeBound))
                    }
                }, {
                    key: "_removeEventHandlers",
                    value: function () {
                        1 === s._sidenavs.length && document.body.removeEventListener("click", this._handleTriggerClick), this.dragTarget.removeEventListener("touchmove", this._handleDragTargetDragBound, {
                            passive: !0
        ...
        var i = {
            ...
            n = function (n) {
                function s(e, i) {
                    _classCallCheck(this, s);
                    var n = _possibleConstructorReturn(this, (s.__proto__ || Object.getPrototypeOf(s)).call(this, s, e, i));
                    return (n.el.M_ScrollSpy = n).options = t.extend({}, s.defaults, i), s._elements.push(n), s._count++, s._increment++, n.tickId = -1, n.id = s._increment, n._setupEventHandlers(), n._handleWindowScroll(), n
                }
                return _inherits(s, Component), _createClass(s, [{
                    key: "destroy",
                    value: function () {
                    ...
                    key: "_handleTriggerClick",
                    value: function (i) {
                        for (var n = t(i.target), o = s._elements.length - 1; 0 <= o; o--) {
                            var a = s._elements[o];
                    ...
                    value: function () {
                        ...
                        (s._visibleElements = s._visibleElements.filter(function (t) {
                            return 0 != t.height()
                        }))[0] && (t(this.options.getActiveElement(s._visibleElements[0].attr("id"))).removeClass(this.options.activeClass), (s._visibleElements = s._visibleElements.filter(function (t) {
                            return t.attr("id") != e.$el.attr("id")
                        }))[0] && t(this.options.getActiveElement(s._visibleElements[0].attr("id"))).addClass(this.options.activeClass))
                    }
                }], [{
                    key: "init",
                    value: function (t, e) {
        ...
        var e = {
            ...
            i = function (i) {
                function n(e, i) {
                    _classCallCheck(this, n);
                    var s = _possibleConstructorReturn(this, (n.__proto__ || Object.getPrototypeOf(n)).call(this, n, e, i));
                    return (s.el.M_Autocomplete = s).options = t.extend({}, n.defaults, i), s.isOpen = !1, s.count = 0, s.activeIndex = -1, s.oldVal, s.$inputField = s.$el.closest(".input-field"), s.$active = t(), s._mousedown = !1, s._setupDropdown(), s._setupEventHandlers(), s
                }
                return _inherits(n, Component), _createClass(n, [{
                    key: "destroy",
                    value: function () {
                    ...
                    value: function (e) {
                        ...
                        i === M.keys.ENTER && 0 <= this.activeIndex ? (s = t(this.container).children("li").eq(this.activeIndex)).length && (this.selectOption(s), e.preventDefault()) : i !== M.keys.ARROW_UP && i !== M.keys.ARROW_DOWN || (e.preventDefault(), i === M.keys.ARROW_UP && 0 < this.activeIndex && this.activeIndex--, i === M.keys.ARROW_DOWN && this.activeIndex < o - 1 && this.activeIndex++, this.$active.removeClass("active"), 0 <= this.activeIndex && (this.$active = t(this.container).children("li").eq(this.activeIndex), this.$active.addClass("active")))
                    }
                }, {
    ...
    function (t) {
        M.updateTextFields = function () {
            t("input[type=text], input[type=password], input[type=email], input[type=url], input[type=tel], input[type=number], input[type=search], input[type=date], input[type=time], textarea").each(function (e, i) {
                var n = t(this);
                0 < e.value.length || t(e).is(":focus") || e.autofocus || null !== n.attr("placeholder") ? n.siblings("label").addClass("active") : e.validity ? n.siblings("label").toggleClass("active", !0 === e.validity.badInput) : n.siblings("label").removeClass("active")
            })
            ...
            if (e instanceof Element && (e = t(e)), e.length) {
                ...
                i.html(d), 0 < e[0].offsetWidth && 0 < e[0].offsetHeight ? i.css("width", e.width() + "px") : i.css("width", window.innerWidth / 2 + "px"), e.data("original-height") <= i.innerHeight() ? e.css("height", i.innerHeight() + "px") : e[0].value.length < e.data("previous-length") && e.css("height", e.data("original-height") + "px"), e.data("previous-length", e[0].value.length)
        ...
        var i = {
            ...
            n = function (n) {
                function s(i, n) {
                    ...
                    return (o.el.M_Slider = o).options = t.extend({}, s.defaults, n), o.$slider = o.$el.find(".slides"), o.$slides = o.$slider.children("li"), o.activeIndex = o.$slides.filter(function (e) {
        ...
        var e = {
            ...
            i = function (i) {
                function n(e, i) {
                    _classCallCheck(this, n);
                    var s = _possibleConstructorReturn(this, (n.__proto__ || Object.getPrototypeOf(n)).call(this, n, e, i));
                    return (s.el.M_Pushpin = s).options = t.extend({}, n.defaults, i), s.originalOffset = s.el.offsetTop, n._pushpins.push(s), s._setupEventHandlers(), s._updatePosition(), s
                }
                return _inherits(n, Component), _createClass(n, [{
                    key: "destroy",
                    value: function () {
        ...
        var n = function (n) {
            ...
            return _inherits(s, Component), _createClass(s, [{
                ...
                value: function () {
                    ...
                    this.$anchor.append(a), this.offsetX = o.left - n / 2 + o.width / 2, this.offsetY = s - o.bottom, e = n / a[0].clientWidth, this.btnBottom = o.bottom, this.btnLeft = o.left, this.btnWidth = o.width, this.$el.addClass("active"), this.$el.css({
                        "text-align": "center",
                        width: "100%",
                        bottom: 0,
                        left: 0,
                ...
                return _inherits(n, Component), _createClass(n, [{
                    ...
                    value: function (t, e) {
                        ...
                        if ("string" == typeof t && (t = new Date(Date.parse(t))), n._isDate(t)) {
                            ...
                            n._isDate(i) && t < i ? t = i : n._isDate(s) && s < t && (t = s), this.date = new Date(t.getTime()), this._renderDateDisplay(), n._setToStartOfDay(this.date), this.gotoDate(this.date), e || "function" != typeof this.options.onSelect || this.options.onSelect.call(this, this.date)
                        }
                    }
                }, {
                    key: "setInputValue",
                    ...
                    value: function (t, e, i) {
                        ...
                        for (var d = 0 === e ? 11 : e - 1, u = 11 === e ? 0 : e + 1, c = 0 === e ? t - 1 : t, p = 11 === e ? t + 1 : t, v = n._getDaysInMonth(c, d), f = a + r, m = f; 7 < m;) m -= 7;
                        f += 7 - m;
                        for (var g = !1, _ = 0, y = 0; _ < f; _++) {
                            ...
                            h.push(this.renderDay(B)), 7 == ++y && (l.push(this.renderRow(h, s.isRTL, g)), y = 0, g = !(h = []))
                        }
        ...
        var e = {
            ...
            i = function (i) {
                function n(e, i) {
                    _classCallCheck(this, n);
                    var s = _possibleConstructorReturn(this, (n.__proto__ || Object.getPrototypeOf(n)).call(this, n, e, i));
                    return (s.el.M_Timepicker = s).options = t.extend({}, n.defaults, i), s.id = M.guid(), s._insertHTMLIntoDOM(), s._setupModal(), s._setupVariables(), s._setupEventHandlers(), s._clockSetup(), s._pickerSetup(), s
                }
                return _inherits(n, Component), _createClass(n, [{
                    key: "destroy",
                    value: function () {
                    ...
                    value: function (t, e) {
                        ...
                        this.time = s, !e && this.options.twelveHour && (s = s + " " + this.amOrPm), (this.el.value = s) !== i && this.$el.trigger("change"), this.close(), this.el.focus()
                    }
                }, {
                    key: "clear",
                    value: function () {
        ...
        var e = {},
            i = function (i) {
                function n(e, i) {
                    _classCallCheck(this, n);
                    var s = _possibleConstructorReturn(this, (n.__proto__ || Object.getPrototypeOf(n)).call(this, n, e, i));
                    return (s.el.M_CharacterCounter = s).options = t.extend({}, n.defaults, i), s.isInvalid = !1, s.isValidLength = !1, s._setupCounter(), s._setupEventHandlers(), s
                }
                return _inherits(n, Component), _createClass(n, [{
                    key: "destroy",
                    value: function () {
                ...
                return _inherits(n, Component), _createClass(n, [{
                    ...
                    value: function (e) {
                        ...
                        for (r = 1; r <= n; ++r) {
                            ...
                            if (this.options.fullWidth ? (d = this.options.dist, u = r === n && 0 < s ? 1 - a : 1) : (d = this.options.dist * (2 * r - a * o), u = 1 - v * (2 * r - a * o)), !this.noWrap || 0 <= this.center - r) {
                                l = this.images[this._wrap(this.center - r)];
        ...
        var e = {
            ...
            i = function (i) {
                function n(e, i) {
                    _classCallCheck(this, n);
                    var s = _possibleConstructorReturn(this, (n.__proto__ || Object.getPrototypeOf(n)).call(this, n, e, i));
                    return (s.el.M_TapTarget = s).options = t.extend({}, n.defaults, i), s.isOpen = !1, s.$origin = t("#" + s.$el.attr("data-target")), s._setup(), s._calculatePositioning(), s._setupEventHandlers(), s
                }
                return _inherits(n, Component), _createClass(n, [{
                    key: "destroy",
                    value: function () {
        ...
        var e = {
            ...
            i = function (i) {
                function n(e, i) {
                    _classCallCheck(this, n);
                    var s = _possibleConstructorReturn(this, (n.__proto__ || Object.getPrototypeOf(n)).call(this, n, e, i));
                    return s.$el.hasClass("browser-default") ? _possibleConstructorReturn(s) : ((s.el.M_FormSelect = s).options = t.extend({}, n.defaults, i), s.isMultiple = s.$el.prop("multiple"), s.el.tabIndex = -1, s._keysSelected = {}, s._valueDict = {}, s._setupDropdown(), s._setupEventHandlers(), s)
                }
                return _inherits(n, Component), _createClass(n, [{
                    key: "destroy",
                    value: function () {
        ...
        var i = {},
            n = function (n) {
                function s(e, i) {
                    _classCallCheck(this, s);
                    var n = _possibleConstructorReturn(this, (s.__proto__ || Object.getPrototypeOf(s)).call(this, s, e, i));
                    return (n.el.M_Range = n).options = t.extend({}, s.defaults, i), n._mousedown = !1, n._setupThumb(), n._setupEventHandlers(), n
                }
                return _inherits(s, Component), _createClass(s, [{
                    key: "destroy",
                    value: function () {
